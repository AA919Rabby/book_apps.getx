...
A Flutter app built with **GetX** for managing and reading poems.  
This project is part of my Flutter learning and portfolio.

## Features
- Beautiful poems list & poem UI
- View detailed info about each poems
